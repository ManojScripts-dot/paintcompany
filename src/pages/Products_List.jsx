      ...
      try {
        ...
        if (response.status === 200) {
          ...
          const priceFieldsMap = {
            "Silver/Copper/Gold": ["1kg", "500g", "200g", "100g", "50g"],
            "Metal and Wood Primer": ["20L", "4L", "1L", "500ml", "200ml"],
            "Metal and Wood Enamel": ["20L", "4L", "1L", "500ml", "200ml"],
            "Aluminium P LCAints": ["20L", "4L", "1L", "500ml", "200ml"],
            "Distemper": ["20L", "10L", "5L", "1L"],
            default: ["20L", "10L", "4L", "1L"],
          };
          ...
          categoryOrder.forEach((categoryName) => {
            categoryMap[categoryName] = {
              ...
              products: [],
              columns: priceFieldsMap[categoryName] || priceFieldsMap.default,
            };
          });
          ...
          allProducts.forEach((product) => {
            ...
            priceFields.forEach((field) => {
              const priceKey = `price${field}`;
              if (product[priceKey]) {
                prices[field] = product[priceKey];
              }
            });
            ...
            categoryMap[categoryName].products.unshift({
              id: product.id,
              name: product.name,
              prices,
              image: imageUrl,
              ...
              <div className="hidden md:flex mt-4 items-center">
                {hasActiveFilters && (
                  <>
                    ...
                    {searchTerm && (
                      <span className="inline-flex items-center px-2 py  rounded-full text-xs font-medium bg-red-100 text-red-800 mr-2">
                        Search: {searchTerm}
